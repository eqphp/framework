...
//替换为指定字符
$safe=array('zneqz,zatz,znumberz,zdollarz,zpercentz,zandz,zaskz,ztildez,zsquarez,zlessz,zgreaterz,zapostrophez,zsquotez,zdquotez,zbackslashz',
'zplusz,zminusz,zbyz,zmodz,zeqzzlcurlyz,zrcurlyz,zlbracketz,zrbracketz,zlparenz,zrparenz,zdividez,zunderlinez,zcommaz,zdotz,zcolonz,zsemicolonz');
...
return base64_decode(str_replace($password,'',implode($buffer)));
}
