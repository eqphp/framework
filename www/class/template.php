...
public $tpl_template_dir=dc_view_view;
public $tpl_compile_dir=dc_cache_compile;
...
$tplTemp=explode('/',$tpl); //支持下级目录, 如: $tpl->display('dir/xxxx.tpl');
...
return self::tpl_remove_cache(dc_root.$this->tpl_compile_dir);
}
	
//需要独立使用时需将此函数移到系统函数库文件中
static function tpl_remove_cache($dirPath) {
