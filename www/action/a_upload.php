...
class a_upload{
    ...
    static function upload(){
        ...
        $ext_arr=array('pic'=>explode(',',$cf_type['pic']),'media'=>explode(',',$cf_type['media']),'doc'=>explode(',',$cf_type['doc']),'html'=>explode(',',$cf_type['html']),'zip'=>explode(',',$cf_type['zip']));
    ...
    private static function get($input_name='file_name'){
        ...
        if (is_uploaded_file($input_file['tmp_name'])) {
            ...
            return array('size'=>$input_file['size'],'type'=>strtolower($suffix[0]),'file'=>$input_file['name'],'name'=>$input_file['tmp_name'],'error'=>$input_file['error']);
        }
    }
