...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			//size
			//'<div class="ke-dialog-row">',
			//'<label for="keWidth" style="width:60px;">图片宽度</label>', //' + lang.size + '
			// lang.width + 
			//' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> (空置为原始大小，不缩放)',
		...
		var uploadbutton = K.uploadbutton({
			...
			fieldName : 'imgFile',
			url : K.addParam(uploadJson, 'dir=pic'),
