...
if (!($this->sock && $this->act_smtp())) {
log::exception('mail','cannot connenct to relay host '.$this->relay_host);
log::exception('mail',$errstr.' ('.$errno.')');
return false;
}
return true;;
...
return new mail($mail['host'],$mail['port'],$mail['user'],$mail['pwd'],true);
}
...
$info=file_get_contents(dc_view_templat.$tpl.'.html');
